<template>
  <svg fill="currentColor" role="presentation" height="16" width="16" aria-label="Ses seviyesi orta" id="volume-icon" viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 hDgDGI">
